    ...
    fn test_tls_extensions() {
        ...
        let expected = Ok((
            ...
            vec![
                ...
                TlsExtension::SupportedGroups(ecc),
                TlsExtension::SessionTicket(empty),
                TlsExtension::SignatureAlgorithms(vec![
                    SignatureScheme(0x0601),
                    SignatureScheme(0x0602),
                    SignatureScheme(0x0603),
                    SignatureScheme(0x0501),
                    SignatureScheme(0x0502),
                    SignatureScheme(0x0503),
                    SignatureScheme(0x0401),
                    SignatureScheme(0x0402),
                    SignatureScheme(0x0403),
                    SignatureScheme(0x0301),
                    SignatureScheme(0x0302),
                    SignatureScheme(0x0303),
                    SignatureScheme(0x0201),
                    SignatureScheme(0x0202),
